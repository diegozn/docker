...
public class TelaPrincipalVm extends javax.swing.JFrame {
    ...
    List<Totem> verificacaoTotemSql = connect.getJdbc().query(String.format("SELECT * FROM totem WHERE id_processador='%s' AND serial_disco='%s' AND hostname='%s'",comps.getIdProcessador(), comps.getSerialDisco(), comps.getHostname()), new BeanPropertyRowMapper<>(Totem.class));
